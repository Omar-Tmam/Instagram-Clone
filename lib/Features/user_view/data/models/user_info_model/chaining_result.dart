...
class ChainingResult extends Equatable {
  ...
  factory ChainingResult.fromJson(Map<String, dynamic> json) {
    return ChainingResult(
      chainingInfo: json['chaining_info'] == null
          ? null
          : ChainingInfo.fromJson(
              json['chaining_info'] as Map<String, dynamic>),
      fullName: json['full_name'] as String?,
      id: json['id'] as String?,
      isPrivate: json['is_private'] as bool?,
      isVerified: json['is_verified'] as bool?,
      profileChainingSecondaryLabel:
          json['profile_chaining_secondary_label'] as String?,
